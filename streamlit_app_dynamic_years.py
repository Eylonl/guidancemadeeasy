...
if results:
    ...
    # Select the most relevant columns for display - ENSURE "Value" IS INCLUDED HERE
    ...
    # Critical: Make sure we preserve the Value column even if some columns are missing
    if "Value" in combined.columns and "Value" not in display_df.columns:
        # Create a new DataFrame that explicitly includes the Value column
        value_included_cols = [col for col in display_df.columns]
